...
#download3 = URI.open('https://github.com/nightingaleproject/vital_records_sandbox_ig/blob/main/input/mapping/BFDR_Forms_Mapping.xlsx?raw=true')
#IO.copy_stream(download3, 'input/mapping/BFDR_Forms_Mapping.xlsx')
