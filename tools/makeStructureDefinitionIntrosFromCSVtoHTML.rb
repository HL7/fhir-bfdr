# NOTE: Before running this script, you should download a local copy of the latest spreadsheets from https://github.com/HL7/vr-common-library
...
#Invoke-Webrequest https://github.com/HL7/vr-common-library/blob/master/input/mapping/Forms_Mapping.csv?raw=true -Outfile "./input/mapping/BFDR_Forms_Mapping.csv"
    ...
    if !row[INTRO_IJE_MAPPING_COL].to_s.to_s.empty?
      ...
      if vProfileName == "ObservationCodedRaceAndEthnicityVitalRecords" || vProfileName == "ObservationInputRaceAndEthnicityVitalRecords"
        ...
        CSV.foreach(pIJEMappingSpreadsheet) do |row|
          ...
          vIntroOutputFile.puts "  <td>" + (row[IJE_FHIR_FIELD_COL].to_s.empty? ? "-" : row[IJE_FHIR_FIELD_COL].to_s) + "</td>"
