...
// The following are factored out as rulesets to ensure that they are reproduced faithfully in both the Provider and Jurisdiction reports

RuleSet: motherPrenatalFetalDeathSlices
...
RuleSet: medicalHealthInformatioFetalDeathSlices
...
RuleSet: motherInformationFetalDeathSlices
...
RuleSet: fatherInformationFetalDeathSlices
...
RuleSet: emergingIssuesFetalDeathSlices
