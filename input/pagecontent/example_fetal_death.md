...
| Placental Exam | [`Performed`](Observation-observation-placental-exam-performed-not-named.html)  |
| Histological Exam Results Used | [`Yes`](Observation-observation-autopsy-histological-exam-results-used-not-named)  |
...
| Number of Previous Live Births     | [`Living = 1`](Observation-observation-infant-living-carmen-teresa-lee.html), [`Dead = 0`](Observation-observation-number-births-now-dead-carmen-teresa-lee.html)  |
...
| Risk Factors During Pregnancy     | [`Gestational Hypertension`](Condition-condition-gestational-hypertension-carmen-teresa-lee.html), [`Cesareans = 1'], (Observation-observation-number-previous-cesareans-carmen-teresa-lee.html)  |
