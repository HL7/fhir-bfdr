 ...
 * the <a href='http://hl7.org/fhir/extensions/StructureDefinition-patient-birthPlace.html'>patient-birthPlace</a>(http://hl7.org/fhir/StructureDefinition/patient-birthPlace) extension
 * the <a href='http://hl7.org/fhir/extensions/StructureDefinition-patient-birthTime.html'>patient-birthTime</a>(http://hl7.org/fhir/StructureDefinition/patient-birthTime) extension
 * the <a href='http://hl7.org/fhir/extensions/StructureDefinition-patient-multipleBirthTotal.html'>patient-multipleBirthTotal</a>(http://hl7.org/fhir/StructureDefinition/patient-multipleBirthTotal) extension to record plurality
...
<tr>
  ...
  <td>codeable</td>
  <td><a href='https://build.fhir.org/ig/HL7/vr-common-library/ValueSet-ValueSet-birth-sex-child-vr.html'>ValueSetBirthSexChildVitalRecords</a></td>
</tr>
<tr>
  <td style='text-align: center'>Natality</td>
  <td>8</td>
