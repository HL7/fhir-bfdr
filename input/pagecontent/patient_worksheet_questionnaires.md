...
* It is possible to send the resulting QuestionnaireResponse contained in the relevant Composition ([Composition - Provider Live Birth Report][CompositionProviderLiveBirthReport] or [Composition - Provider Fetal Death Report][CompositionProviderFetalDeathReport]).
