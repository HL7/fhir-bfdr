...
| 290 | State, U.S. Territory or Canadian Province of Birth (Father) - code | FBPLACD_ST_TER_C| [Extension-relatedperson-birthplace]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-Extension-relatedperson-birthplace)| VRCPL| 
| 291 | Father's Country of Birth (Code) | FBPLACE_CNT_C| [Extension-relatedperson-birthplace]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-Extension-relatedperson-birthplace)| VRCPL| 
| 308 | Father's Country of Birth (Literal) | FBPLACE_CNTRY_TXT| [Extension-relatedperson-birthplace]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-Extension-relatedperson-birthplace)| VRCPL| 
| 307 | State, U.S. Territory or Canadian Province of Birth (Father) - literal | FBPLACE_ST_TER_TXT| [Extension-relatedperson-birthplace]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-Extension-relatedperson-birthplace)| VRCPL| 
...
| 81 | Father of Hispanic Origin?--Puerto Rican | FETHNIC2| [us-core-ethnicity]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-us-core-ethnicity)| VRCPL| 
| 82 | Father of Hispanic Origin?--Cuban | FETHNIC3| [us-core-ethnicity]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-us-core-ethnicity)| VRCPL| 
| 83 | Father of Hispanic Origin?--Other | FETHNIC4| [us-core-ethnicity]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-us-core-ethnicity)| VRCPL| 
| 84 | Father of Hispanic Origin?--Other Literal | FETHNIC5| [us-core-ethnicity]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-us-core-ethnicity)| VRCPL| 
...
| 160 | <html>Risk Factors--Hypertension Gestational   <b><i>(SEE ADDITIONAL HYPERTENSION CATEGORY IN LOCATION 924 TO REFLECT RECOMMENDED CHANGES EFFECTIVE 2004)</i></b></html> | GHYPE| [Condition-gestational-hypertension-vr]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-Condition-gestational-hypertension-vr)| VRCPL| 
...
| 277 | State, U.S. Territory or Canadian Province of Birth (Father) - code | FBPLACD_ST_TER_C| [Extension-relatedperson-birthplace]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-Extension-relatedperson-birthplace)| VRCPL| 
| 278 | Father's Country of Birth (Code) | FBPLACE_CNT_C| [Extension-relatedperson-birthplace]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-Extension-relatedperson-birthplace)| VRCPL| 
| 282 | Father's Country of Birth (Literal) | FBPLACE_CNTRY_TXT| [Extension-relatedperson-birthplace]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-Extension-relatedperson-birthplace)| VRCPL| 
| 281 | State, U.S. Territory or Canadian Province of Birth (Father) - literal | FBPLACE_ST_TER_TXT| [Extension-relatedperson-birthplace]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-Extension-relatedperson-birthplace)| VRCPL| 
| 27 | Date of Birth (Father)--Day | FDOB_DY| [RelatedPerson-father-natural-vr]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-RelatedPerson-father-natural-vr)| VRCPL| 
| 26 | Date of Birth (Father)--Month | FDOB_MO| [RelatedPerson-father-natural-vr]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-RelatedPerson-father-natural-vr)| VRCPL| 
| 25 | Date of Birth (Father)--Year | FDOB_YR| [RelatedPerson-father-natural-vr]({{site.data.fhir.ver.hl7fhirusvrcommonlibrary}}StructureDefinition-RelatedPerson-father-natural-vr)| VRCPL| 
