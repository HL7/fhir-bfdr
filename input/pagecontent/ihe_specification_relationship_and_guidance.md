...
Where possible, the BFDR FHIR IG profiles also include the relevant IJE data element names and mapping are provided for [natality](ije_mapping_natality.html) and [fetal death](ije_mapping_fetalDeath.html). See the [EHR Data Mapping](EHR_Data_mapping.html) page for a summary of the IJE, BFDR, and IHE value set information.
