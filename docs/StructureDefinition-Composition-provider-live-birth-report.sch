...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition/f:encounter">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/bfdr/StructureDefinition/Extension-encounter-maternity-reference']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/bfdr/StructureDefinition/Extension-encounter-maternity-reference': maximum cardinality of 'extension' is 1</sch:assert>
